...
class ReplyTemplateCategory(models.Model):
    """Category for reply templates used to group prepared responses."""
...
class ReplyTemplate(models.Model):
    """Prepared reply text snippets organized by category and channel."""
    ...
    channel = models.CharField(max_length=50, default=CHANNEL_ALL, help_text='telegram, instagram, whatsapp, all')
