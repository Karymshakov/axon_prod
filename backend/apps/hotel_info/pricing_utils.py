...
def query_meal_plan_pricing(room_type, guest_count, checkin_date=None):
    ...
    if not matches:
        ...
        # e.g. "Семейный" matches "семейный номер"
...
COMBINATIONS_MAP = {
    ...
    5: [
        ...
        {"rooms": ["стандарт двухместный", "комфорт двухместный", "стандарт одноместный"]},
        {"rooms": ["семейный номер", "стандарт одноместный"]},
    ],
    6: [
        ...
        {"rooms": ["стандарт двухместный", "стандарт двухместный", "комфорт двухместный"]},
        {"rooms": ["семейный номер", "стандарт двухместный"]},
    ],
    7: [
        ...
        {"rooms": ["стандарт двухместный", "стандарт двухместный", "комфорт двухместный", "комфорт одноместный"]},
        {"rooms": ["семейный номер", "стандарт двухместный", "стандарт одноместный"]},
    ],
    8: [
        ...
        {"rooms": ["стандарт двухместный", "стандарт двухместный", "комфорт двухместный", "комфорт двухместный"]},
        {"rooms": ["семейный номер", "семейный номер"]},
    ],
    9: [
        ...
        {"rooms": ["стандарт двухместный", "стандарт двухместный", "комфорт двухместный", "комфорт двухместный", "стандарт одноместный"]},
        {"rooms": ["семейный номер", "семейный номер", "стандарт одноместный"]},
    ],
    10: [
        ...
        {"rooms": ["стандарт двухместный", "стандарт двухместный", "комфорт двухместный", "комфорт двухместный", "комфорт двухместный"]},
        {"rooms": ["семейный номер", "семейный номер", "стандарт двухместный"]},
    ],
}
