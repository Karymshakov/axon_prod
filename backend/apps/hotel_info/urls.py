...
from .views import (
    hotel_profile, prompt_preview, booking_rules,
    ...
    AutomationMessageTemplateViewSet,
)
...
router.register(r'automation-message-templates', AutomationMessageTemplateViewSet, basename='automation-message-template')
...
urlpatterns = [
    ...
    path('booking-rules/', booking_rules, name='booking-rules'),
