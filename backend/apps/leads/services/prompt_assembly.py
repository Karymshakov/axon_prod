...
_PROMPT_PRIORITY_PREAMBLE = (
    ...
    "If the latest media context says `exact_room_category_verified: false`, do not name Comfort, Standard Queen, "
    "Standard Twin, or Family as the exact room. A stored booking room preference is not proof of what is shown "
    "in a new guest-sent image. "
