...
import { ArrowLeftIcon, Loader2Icon, MailIcon, LockIcon, Sparkles } from 'lucide-react'
      ...
      >
        ...
        >
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
              {error ? (
                <div
                  className="rounded-xl p-4 text-sm text-red-600"
                  style={{
                    ...
                    <FormControl>
                      <div className="relative">
                        <MailIcon
                          ...
                          style={{ color: focusedField === 'email' ? '#2461FF' : '#94a3b8' }}
                        />
                        <Input
                          {...field}
                          type="email"
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        <LockIcon
                          className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 transition-colors duration-200"
                          style={{ color: focusedField === 'password' ? '#2461FF' : '#94a3b8' }}
                        />
                        <Input
                          {...field}
                          type="password"
              ...
              <button
                ...
                style={{
                  background: 'linear-gradient(135deg, #2461FF, #7C3AED)',
                  boxShadow: isLoading ? 'none' : '0 4px 20px rgba(36, 97, 255, 0.25)',
        ...
        >
          <p className="text-sm text-slate-500">
            Нет аккаунта?{' '}
            <Link to="/register" className="font-semibold text-[#2461FF] transition-colors hover:text-[#7C3AED]">
              Зарегистрироваться
            </Link>
          </p>
          <Link
